...
String _androidUserAgent({
  ...
  required String build,
    ...
    'Chrome/${tdbChromeBuild()} Mobile Safari/537.36';
...
String _iosUserAgent(String ver) {
  ...
  return 'Mozilla/5.0 (iPhone; CPU iPhone OS $dotless like Mac OS X) '
      'AppleWebKit/${tdbSafariBuild()} (KHTML, like Gecko) '
      'Version/$ver Mobile/15E148 Safari/${tdbSafariBuild()}';
}
...
class TdbHttp extends http.BaseClient {
